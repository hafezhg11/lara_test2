...
{{--                        <label for="exampleInputEmail1">{{__('translate.Users')}}</label>--}}
                        <input name="firstname" class="form-control" value="{{ old( 'firstname', $user->firstname) }}" id="" placeholder="{{__('user.First Name')}}" type="text">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('user.Last Name')}}</label>
                        <input name="lastname" class="form-control" value="{{ old( 'lastname', $user->lastname) }}" id="" placeholder="{{__('user.Last Name')}}" type="text">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('user.Contract Date')}}</label>
                        <input name="contract_date" class="form-control" value="{{ old( 'contract_date', $user->contract_date) }}" id="" placeholder="{{__('user.Contract Date')}}" type="text">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('user.National Number')}}</label>
                        <input name="ssn" class="form-control" value="{{ old( 'ssn', $user->ssn) }}" id="" placeholder="{{__('user.National Number')}}" type="text">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('user.Date Of Birth')}}</label>
                        <input name="dob" class="form-control" value="{{ old( 'dob', $user->dob) }}" id="" placeholder="{{__('user.Date Of Birth')}}" type="text">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">{{__('user.Email address')}}</label>
                        <input name="email" class="form-control" value="{{ old( 'email', $user->email) }}" id="exampleInputEmail1" placeholder="{{__('user.Email address')}}" type="email">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">{{__('user.Password')}}</label>
                        <input name="password" class="form-control" value="{{ old( 'password', $user->password) }}" id="exampleInputPassword1" placeholder="{{__('user.Password')}}" type="password">
                    </div>
                    {{--<div class="form-group">--}}
