        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <!-- Messages: style can be found in dropdown.less-->
                    <li class="dropdown messages-menu">
                        {{--                        <a href="/{{ App::getLocale()}}/index" class="dropdown-toggle" data-toggle="dropdown tooltip" title="فارسی">--}}
                ...
                {{--<a href="/en/layout" class="dropdown-toggle" data-toggle="dropdown tooltip" title="English">--}}
                {{--<img src="../assets/img/country_img/en.png" class="img-circle fa" alt="English">--}}
                {{--</a>--}}
                {{----}}
                {{--</li>--}}
                <!-- User Account: style can be found in dropdown.less -->
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            {{--<span class="hidden-xs">Hafez Heibati</span>--}}
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{URL::to('service/create')}}"><i class="fa fa-circle-o"></i> Create Service</a></li>
                        <li><a href="{{URL::to('service/index')}}"><i class="fa fa-circle-o"></i> View All Services</a></li>
                        s
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-globe"></i> <span>{{__('layout.Locations Management')}}</span>
                        <span class="pull-right-container">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/user/create"><i class="fa fa-circle-o"></i> Create User</a></li>
                        <li><a href="/user/index"><i class="fa fa-circle-o"></i> View All Users</a></li>
