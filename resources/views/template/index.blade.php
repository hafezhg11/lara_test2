...
<section class="content-header">
    <h1>
        ...
        <small>{{__('template.View All Templates')}}</small>
    </h1>
    <ol class="breadcrumb">
...
@foreach ($templates as $template)
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" @if(!\App::isLocale('en')) style="float: right" @endif>
        ...
        <div class="panel panel-info">
            ...
            {{__('template.Template Name')}}: {{$template->name}}
            </div>
            ...
            <div class="panel-footer" >
                ...
                <a title="{{__("template.Show")}}" data-toggle="modal" data-target="#show{{$template->id}}" type="button" class="btn btn-sm btn-primary" ><i class="fa fa-list"></i></a>
                <span class="pull-right">
                    <a href="<?= url('template/'.$template->id.'/edit'); ?>" data-original-title="{{__("template.Edit")}}" data-target="#{{$template->id}}" type="submit" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                    <a data-original-title="{{__("template.Delete")}}" data-toggle="modal" data-target="#delete{{$template->id}}" type="button" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i></a>
                </span>
            </div>
        </div>
    ...
    {{--delete modal--}}
        <div class="modal fade" id="delete{{$template->id}}" tabindex="-1" role="dialog" aria-labelledby="mylable" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        ...
                        <form action="<?= url('template/'.$template->id) ?>" method="POST">
                            ...
                            <div class="modal-body">
                                <h3>{{__('template.Are you sure you want to delete the following template?')}} <hr>
                                     {{$template->name}}</h3>
                            </div>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-danger" value="{{__('template.Delete')}}">
     ...
     {{--/. delete modal--}}
        {{--show modal--}}
        <div class="modal" id="show{{$template->id}}" tabindex="-1" role="dialog" aria-labelledby="mylable" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            {{--<p>{{ __('template.Template Of Origin') }}:--}}
